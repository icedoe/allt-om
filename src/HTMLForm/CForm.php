...
public function noValid($nv=true){
    $this->noValid =$nv;
}
...
$noValid=false;
            foreach($this->elements as $element) {
                if(isset($element['callback']) && isset($element['no-validate'])){
                    $noValid =true;
                }
            }
                ...
                if (isset($request[$element['name']])) {
                    ...
                    if (isset($element['validation'])) {
                        ...
                        if ($element['validation-pass'] === false) {
                            ...
                            $validates = isset($element['no-validate']) ? true : false;
        ...
        $validates =$this->noValid ? $this->noValid: $validates;
